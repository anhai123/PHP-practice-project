...
class AdminController
{
    ...
    function edit() {
        ...
        if ($_POST['action'] == 'edit' && $_POST['id']) {	
            ...
            $firstName= htmlspecialchars(isset($_POST['firstName']) && $_POST['firstName'] == true ?trim($_POST['firstName'], " ") : '');
            $lastName= htmlspecialchars(isset($_POST['lastName']) && $_POST['lastName'] == true ?trim($_POST['lastName'], " ") : '');
